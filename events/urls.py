...
from .views import  home_page, event_page, create_event, create_category,admin_home,event_detail,update_event,update_category,delete_event,delete_category,user_list,assign_role,create_group,group_list,delete_group,rsvp_event,participant_dashboard
